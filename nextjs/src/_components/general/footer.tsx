        ...
        <footer className="border-t border-stroke px-4">
            <div
                ...
                <div className="flex items-center justify-center font-extrabold gap-2 text-2xl">
                    ...
                    <span>and</span>
                    <Link href="https://strapi.io/" target="_blank" rel="noopener noreferrer">
                        <Image src={"/strapi.png"} alt={"Strapi image"} width={120} height={30}/>
                    </Link>
                    <span>with love</span>
                </div>
                <div className="text-center">
                    <span className="font-medium">&copy;2024 Gabriel Filiot. Tous droits réservés.</span>
                </div>
            </div>
        </footer>
    );

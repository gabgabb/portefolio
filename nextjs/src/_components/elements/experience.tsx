    ...
    return (
        <div className="flex flex-1 justify-between">
            <div className="flex gap-2 items-center">
                <Image src={logo} className="rounded-full my-auto" width={35} height={35}/>
                <div className="flex flex-col justify-center">
                    <div className="flex gap-2 items-center">
                        <span className="font-bold text-[22px] h-7">{companyName}</span>
                        {isMission && (
                            <p className="border-2 border-white/70 rounded-md text-[13px] max-h-max px-1 py-[0.5px] font-normal">Mission</p>
                        )}
                    </div>
                    <span className="font-light text-[16px] text-white/80">{jobTitle}</span>
                </div>
            </div>
